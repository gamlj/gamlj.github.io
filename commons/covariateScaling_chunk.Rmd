...
__`Covariates conditioning`__ rules how the model is conditioned to different values of the continuous independent variables in the _simple effects_ estimation and in the _plots_ when there is an interaction in the model.
...
__`Covariates labeling`__ decides which label should be associated with the estimates and plots of simple effects as follows:
