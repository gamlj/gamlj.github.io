...
Polinomial effects for continuous variables can be added to the model. When a variable is selected in the `r opt("Components")` field, a little number appears on the right side of the selection. The number indicates the _order_ of the effect. 
