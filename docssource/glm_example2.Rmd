...
In this example we work out an example of polynomial regression in the GLM, using jamovi GAMLj. Data are (simulated data) [here](https://github.com/mcfanda/gamlj/data/qsport.csv). 
