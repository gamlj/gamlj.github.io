...
<img src="gzlmmixed/estimates.png" class="img-responsive" alt="">
...
The `r opt("precision/speed")` parameter applies to mixed models with one random effect. Higher numbers increase precision in the estimation with a speed cost. It corresponds to the `nAGQ` parameter of `glmer` command in R package [lme4](https://cran.r-project.org/web/packages/lme4/index.html). For models with more than
