...
One can follow the example by downloading the file `r datafile("subjects on stimuli","subjects_on_stimuli.csv")` and open it in [jamovi](https://www.jamovi.org/download.html).
We have 50 participants with two repeated measures conditions (0 and 1). 
