...
The design and the analyses are inspired by [Sean Anderson's course on mixed model in R](https://github.com/seananderson/glmm-course). If you are interested in checking the results with R, you can find all the R code on Anderson's GitHub page. The data can be downloaded from Anderson's glmm-course page.
...
For instance, if there are three repeated measures, the model must estimate 3⋅(3−1)/2=33⋅(3−1)/2=3 correlations. But if there are 10 measures, the number of correlations increases to 10⋅(10−1)/2=4510⋅(10−1)/2=45. To simplify the estimation process, researchers often avoid estimating all these correlations and instead impose certain restrictions on the structure of the correlation matrix. This is commonly referred to as _modelling covariance of residuals_.
...
`r pic("examples/mixed4/data_input1.png")`
...
`r pic("examples/mixed4/mod1_plot2.png")`
...
`r pic("examples/mixed4/mod2_input1.png")`
...
`r pic("examples/mixed4/mod2_output1.png")`
...
`r pic("examples/mixed4/mod2_plot1.png")`
`r pic("examples/mixed4/mod2_plot2.png")`
