...
* Cohen's d (sample SD) $d_{mod}$: the means difference is divided by the pooled standard deviation computed within each group. 
...
`r link_pages("details_glm_effectsize")`
