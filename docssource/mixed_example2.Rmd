...
We use the GAMLj module in Jamovi. One can follow the example by downloading the file [howell_rep](https://github.com/mcfanda/gamlj/blob/master/data/howell_rep.csv) and open it in [jamovi](https://www.jamovi.org/download.html). Be sure to install GAMLj module from within jamovi library. 
