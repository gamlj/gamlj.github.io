...
Often readers wonder if this works also for other coding systems. Sure it does, it is just a little more complicated to see ti. Take the _deviation_ method. Here the model for three-group IV is:
