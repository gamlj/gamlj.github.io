...
Let us inspect the scatterplot representing the relationship between `beers` and `smiles`. By eyeballing the clouds of points, it is clear that a negatively sloped line would represent the outcome of a simple regression.
...
Let us continue our representation of cluster-specific regression lines with the help of some formulas, representing a regression like for each bar: 
