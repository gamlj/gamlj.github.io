...
This is a recap table that says that we did what we wanted to do, and how we did it. The second table we get is the `r opt("Model Fit")` table, where the $R^2$, the adjusted $R^2$, and their inferential test are presented.
