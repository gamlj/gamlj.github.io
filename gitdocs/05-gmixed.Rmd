...
The model fixed effects can be interpreted as in a standard logistic regression. On average across _bars_ (clusters), for the average number of _beers_ drunk ($x$) the expected odd of visiting the restroom is $exp(B)=1.309$. As we increases _beers_ ($x$) of one unit, the odd of visiting the restroom increases of $exp(B)=.954$, it diminishes ^[Here the cover story does not hold. Despites that, what is important is to get that the interpretation of the coefficients is in line with the results].
